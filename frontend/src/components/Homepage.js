  ...
  return (
   <Box width={'100%'} height={'100%'} margin={'auto'} marginTop={2}>
    <Box margin={'auto'} width={'70%'} height={'40vh'} padding={2}>
        <img src="https://www.icicibank.com/content/dam/icicibank/india/managed-assets/images/offer-zone/credit-card/paytm-movies-offer-d.jpg" alt='movie-banner' width={'100%'} height={'100%'} />
    </Box>
